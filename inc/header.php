...
?>
	<section class="headeroption">
		<marquee behavior="alternate" loop="1"><small><center><h1 class="suck">Exam Section</h1></center></small></marquee>
	</section>
	<!-- <style>
	...
	<!-- <section class="headeroption"></section> -->
		...
		?>
			...
			<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: black;">
			  <a class="navbar-brand" href="index.php"><h3 style="text-shadow: 0px 0px 0px white;color: lightgreen">e-Exam</h3></a>
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto">
			      <li class="nav-item active">
			        <h5><a class="nav-link" href="exam.php">HOME</a></h5>
			      </li>
			      <li class="nav-item active">
			        <h5><a class="nav-link" href="?action=logout">Log Out</a></h5>
			      </li>
			    </ul>
